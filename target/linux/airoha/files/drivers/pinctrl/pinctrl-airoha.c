...
#define PORT4_LED0_PHY0_LED0_MAP		(0 << 16)
#define PORT4_LED0_PHY1_LED0_MAP		(1 << 16)
#define PORT4_LED0_PHY2_LED0_MAP		(2 << 16)
#define PORT4_LED0_PHY3_LED0_MAP		(3 << 16)
#define PORT4_LED0_PHY4_LED0_MAP		(4 << 16)
#define LAN3_LED0_MAPPING_MASK 			GENMASK(14, 12)
#define PORT3_LED0_PHY0_LED0_MAP		(0 << 12)
#define PORT3_LED0_PHY1_LED0_MAP		(1 << 12)
#define PORT3_LED0_PHY2_LED0_MAP		(2 << 12)
#define PORT3_LED0_PHY3_LED0_MAP		(3 << 12)
#define PORT3_LED0_PHY4_LED0_MAP		(4 << 12)
#define LAN2_LED0_MAPPING_MASK 			GENMASK(10, 8)
#define PORT2_LED0_PHY0_LED0_MAP		(0 << 8)
#define PORT2_LED0_PHY1_LED0_MAP		(1 << 8)
#define PORT2_LED0_PHY2_LED0_MAP		(2 << 8)
#define PORT2_LED0_PHY3_LED0_MAP		(3 << 8)
#define PORT2_LED0_PHY4_LED0_MAP		(4 << 8)
#define LAN1_LED0_MAPPING_MASK 			GENMASK(6, 4)
#define PORT1_LED0_PHY0_LED0_MAP		(0 << 4)
#define PORT1_LED0_PHY1_LED0_MAP		(1 << 4)
#define PORT1_LED0_PHY2_LED0_MAP		(2 << 4)
#define PORT1_LED0_PHY3_LED0_MAP		(3 << 4)
#define PORT1_LED0_PHY4_LED0_MAP		(4 << 4)
#define LAN0_LED0_MAPPING_MASK 			GENMASK(2, 0)
#define PORT0_LED0_PHY0_LED0_MAP		(0 << 0)
#define PORT0_LED0_PHY1_LED0_MAP		(1 << 0)
#define PORT0_LED0_PHY2_LED0_MAP		(2 << 0)
#define PORT0_LED0_PHY3_LED0_MAP		(3 << 0)
#define PORT0_LED0_PHY4_LED0_MAP		(4 << 0)

#define REG_LAN0_LED1_MAPPING			0x6C
#define LAN4_LED1_MAPPING_MASK 			GENMASK(18, 16)
#define PORT4_LED1_PHY0_LED1_MAP		(0 << 16)
#define PORT4_LED1_PHY1_LED1_MAP		(1 << 16)
#define PORT4_LED1_PHY2_LED1_MAP		(2 << 16)
#define PORT4_LED1_PHY3_LED1_MAP		(3 << 16)
#define PORT4_LED1_PHY4_LED1_MAP		(4 << 16)
#define LAN3_LED1_MAPPING_MASK 			GENMASK(14, 12)
#define PORT3_LED1_PHY0_LED1_MAP		(0 << 12)
#define PORT3_LED1_PHY1_LED1_MAP		(1 << 12)
#define PORT3_LED1_PHY2_LED1_MAP		(2 << 12)
#define PORT3_LED1_PHY3_LED1_MAP		(3 << 12)
#define PORT3_LED1_PHY4_LED1_MAP		(4 << 12)
#define LAN2_LED1_MAPPING_MASK 			GENMASK(10, 8)
#define PORT2_LED1_PHY0_LED1_MAP		(0 << 8)
#define PORT2_LED1_PHY1_LED1_MAP		(1 << 8)
#define PORT2_LED1_PHY2_LED1_MAP		(2 << 8)
#define PORT2_LED1_PHY3_LED1_MAP		(3 << 8)
#define PORT2_LED1_PHY4_LED1_MAP		(4 << 8)
#define LAN1_LED1_MAPPING_MASK 			GENMASK(6, 4)
#define PORT1_LED1_PHY0_LED1_MAP		(0 << 4)
#define PORT1_LED1_PHY1_LED1_MAP		(1 << 4)
#define PORT1_LED1_PHY2_LED1_MAP		(2 << 4)
#define PORT1_LED1_PHY3_LED1_MAP		(3 << 4)
#define PORT1_LED1_PHY4_LED1_MAP		(4 << 4)
#define LAN0_LED1_MAPPING_MASK 			GENMASK(2, 0)
#define PORT0_LED1_PHY0_LED1_MAP		(0 << 0)
#define PORT0_LED1_PHY1_LED1_MAP		(1 << 0)
#define PORT0_LED1_PHY2_LED1_MAP		(2 << 0)
#define PORT0_LED1_PHY3_LED1_MAP		(3 << 0)
#define PORT0_LED1_PHY4_LED1_MAP		(4 << 0)
