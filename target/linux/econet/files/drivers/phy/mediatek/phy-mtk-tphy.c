...
#define U3D_U2PHYDCR1		0x064
#define USB20_SW_PLLMODE		GENMASK(19, 18)
...
/* The U3_PHYA register names seems to collide in different 
 * SoCs. The EN751221 and MT7621 register names differs.
 */
...
#define U3P_U3_PHYA_REG3	0x008
#define P3A_RG_SYSPLL_FBDIV		GENMASK(30, 24)

#define U3P_U3_PHYA_REG4	0x010
...
/* ECONET EN751221 */
#define P3A_RG_PLL_SSC_PRD		GENMASK(15, 0)
...
#define U3P_U3_PHYA_DA_REG9	0x11c
#define P3A_RG_PLL_FBKDIV_PE2H		GENMASK(30, 24)
#define P3A_RG_PLL_FBKDIV_PE1D		GENMASK(22, 16)
#define P3A_RG_PLL_FBKDIV_PE1H		GENMASK(14, 8)
#define P3A_RG_PLL_FBKDIV_U3		GENMASK(6, 0)

#define U3P_U3_PHYA_DA_REG12	0x124
#define U3P_U3_PHYA_DA_REG13	0x128
#define U3P_U3_PHYA_DA_REG14	0x12c
#define U3P_U3_PHYA_DA_REG15	0x130

#define U3P_U3_PHYA_DA_REG19	0x138
#define P3A_RG_PLL_DELTA1_PE1H		GENMASK(31, 16)
#define P3A_RG_PLL_DELTA1_U3		GENMASK(15, 0)

#define U3P_U3_PHYA_DA_REG20	0x13c
#define P3A_RG_PLL_DELTA1_PE2H		GENMASK(31, 16)

#define U3P_U3_PHYA_DA_REG21	0x140
#define P3A_RG_PLL_DELTA_U3		GENMASK(31, 16)

#define U3P_U3_PHYA_DA_REG23	0x144
#define P3A_RG_PLL_DELTA_PE1H		GENMASK(15, 0)
...
struct mtk_phy_pdata {
	...
	/*
	 * set SW PLL Stable mode for ECONET SoCs
	 */
	bool sw_pll_stable_mode;
};
	...
	struct mtk_phy_instance *instance)
{
	...
	if (instance->setup_25mhz_xtal) {
		mtk_phy_update_field(phya + U3P_U3_PHYA_DA_REG9, P3A_RG_PLL_FBKDIV_U3, 0x18);
		...
		writel(0x18000000, phya + U3P_U3_PHYA_DA_REG13);

		writel(0x18000000, phya + U3P_U3_PHYA_DA_REG15);

		mtk_phy_update_field(phya + U3P_U3_PHYA_DA_REG19, P3A_RG_PLL_DELTA1_PE1H, 0x4a);

		mtk_phy_update_field(phya + U3P_U3_PHYA_DA_REG19, P3A_RG_PLL_DELTA1_U3, 0x4a);

		mtk_phy_update_field(phya + U3P_U3_PHYA_DA_REG20, P3A_RG_PLL_DELTA1_PE2H, 0x4a);

		mtk_phy_update_field(phya + U3P_U3_PHYA_DA_REG21, P3A_RG_PLL_DELTA_U3, 0x48);

		mtk_phy_update_field(phya + U3P_U3_PHYA_DA_REG23, P3A_RG_PLL_DELTA_PE1H, 0x48);

		mtk_phy_update_field(phya + U3P_U3_PHYA_DA_REG25, P3A_RG_PLL_DELTA_PE2H, 0x48);

		mtk_phy_update_field(phya + U3P_U3_PHYA_REG9, P3A_RG_PLL_SSC_PRD, 0x190);

		writel(0x1c000000, phya + U3P_U3_PHYA_DA_REG4);

		mtk_phy_update_field(phya + U3P_U3_PHYA_REG3, P3A_RG_SYSPLL_FBDIV, 0xe);
	}
	...
	struct mtk_phy_instance *instance)
{
	...
	if (tphy->pdata->sw_pll_stable_mode) {
				...
				struct mtk_phy_instance *instance)
{
	...
	if (instance->type == PHY_TYPE_USB3) {
		...
		instance->setup_25mhz_xtal = device_property_read_bool(dev, "econet,setup-25mhz-xtal");
	}
...
static const struct of_device_id mtk_tphy_id_table[] = {
	...
	{ .compatible = "econet,en751221-u3phy", .data = &en751221_pdata },
	{ },
};
