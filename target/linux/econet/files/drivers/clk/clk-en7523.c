...
static const struct en_clk_desc en751221_base_clks[] = {
	{
		...
		.base_bits = 2,
		.base_shift = 8,
		.base_values = gsw751221_base,
		.n_base_values = ARRAY_SIZE(gsw751221_base),
...
static const u16 en751221_rst_map[] = {
	...
	[EN751221_FE_PDMA_RST]		= RST_NR_PER_BANK + 1,
	[EN751221_FE_QDMA_RST]		= RST_NR_PER_BANK + 2,
	[EN751221_UNZIP_RST]		= RST_NR_PER_BANK + 3,
...
static void en751221_register_clocks(struct device *dev, struct clk_hw_onecell_data *clk_data,
				   struct regmap *map, void __iomem *base)
{
	...
	for (i = 0; i < ARRAY_SIZE(en751221_base_clks); i++) {
		const struct en_clk_desc *desc = &en751221_base_clks[i];
...
static int en751221_reset_register(struct device *dev, void __iomem *base)
{
	...
	rst_data->rcdev.nr_resets = ARRAY_SIZE(en751221_rst_map);
...
static const struct en_clk_soc_data en751221_data = {
	.num_clocks = ARRAY_SIZE(en751221_base_clks),
